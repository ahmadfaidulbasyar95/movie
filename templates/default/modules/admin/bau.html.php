...
$sys->meta_title = 'User BAU';
?>
<div class="panel panel-danger">
	<div class="panel-heading">
		<h3 class="panel-title">Data BAU</h3>
	</div>
	<div class="panel-body">
		<a href="<?php echo $sys->mod['url_task'].'register/'; ?>" class="btn btn-success"><i class="fa fa-plus"></i> Register BAU</a>
		<br>
		<br>
						...
						<tr>
							...
							<td>
								<div class="checkbox no_margin">
									<label>
										<input type="checkbox" class="toogle_set_active" data_url="<?php echo $sys->mod['url'].'bau/set_active/'.$value['id'].'/'; ?>" value="1" <?php if($value['active']) echo 'checked="checked"'; ?> >
										Active
									</label>
								</div>
							</td>
							<td>
								<a href="<?php echo $sys->mod['url'].'bau/delete/'.$value['id'].'/'; ?>" onclick="return(confirm('Are you sure ?'))" class="text-danger"><i class="fa fa-trash"></i></a>
							</td>
							<td>
