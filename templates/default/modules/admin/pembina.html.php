...
<div class="panel panel-warning">
	...
	<div class="panel-body">
		<a href="<?php echo $sys->mod['url_task'].'register/'; ?>" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Pembina</a>
		<br>
		<br>
						...
						<tr>
							...
							<td>
								<div class="checkbox no_margin">
									<label>
										<input type="checkbox" class="toogle_set_active" data_url="<?php echo $sys->mod['url'].'pembina/set_active/'.$value['id'].'/'; ?>" value="1" <?php if($value['active']) echo 'checked="checked"'; ?> >
										Active
									</label>
								</div>
							</td>
							<td>
								<a href="<?php echo $sys->mod['url'].'pembina/delete/'.$value['id'].'/'; ?>" onclick="return(confirm('Are you sure ?'))" class="text-danger" title="Hapus"><i class="fa fa-trash"></i></a>
							</td>
							<td>
