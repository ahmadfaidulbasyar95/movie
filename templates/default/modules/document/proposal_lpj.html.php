...
if(@$output['document']) 
{
	if($output['document']['id']==$output['proposal_history']['0']['id'] and $session_user_type_mod != 'ukm') 
	{
		...
		<div class="col-xs-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<iframe src="<?php echo $sys->path['url'].$session_user_type_mod.'/decision_lpj/'.$output['document']['id']; ?>" style="border: 0; width: 100%; height: 300px;"></iframe>
				</div>
			</div>
		</div>
		<?php 
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<h3 class="panel-title">
					...
					Document Detail LPJ <?php echo $output['proposal_detail']['name']; ?>
					<?php 
	...
	<div class="col-xs-12 col-sm-4">
		<div class="panel panel-danger">
			<div class="panel-heading">
				...
				Document Timeline LPJ <?php echo $output['proposal_detail']['name']; ?>
			</div>
			<div class="panel-body">
				<div class="tree">
					<ul>
	...
	<div class="col-xs-12">
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title">Document Viewer LPJ <?php echo $output['proposal_detail']['name']; ?></h3>
			</div>
			<div class="panel-body">
				<?php 
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title">
				...
				History Document LPJ <?php echo @$output['proposal_detail']['name']; ?>
			</h3>
		</div>
		<div class="panel-body">
			<div class="table-responsive">
