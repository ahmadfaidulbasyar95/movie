...
if($output['edit']) 
{
	?>
	<?php 
	if(count($output['edit']['timeline']) == 4) 
	{
		?>
		<div class="col-xs-12">
			<?php echo msg('This Proposal has Ready to take Money','success'); ?>
		</div>
		<div class="col-xs-12">
			<div class="panel panel-success">
				<div class="panel-heading">
					<h3 class="panel-title">Member of UKM Who Take money</h3>
				</div>
					...
					<form action="" method="POST" role="form">
						<div class="form-group">
							<select name="member" class="form-control" required="required">
								...
								{
									?>
									<option value="<?php echo $value['id']; ?>" ><?php echo $value['nim']; ?> - <?php echo $value['name']; ?></option>
									<?php 
								}
								?>
							</select>
						</div>
						<button type="submit" class="btn btn-info" name="ok" value="1">Print surat</button>
					</form>
				</div>
			</div>
		</div>
	...
	?>
	<?php 
	if(count($output['edit']['timeline']) == 5) 
	{
		?>
		<div class="col-xs-12">
			<?php echo msg('<a href="'.$sys->mod['url'].'proposal_lpj_detail/'.$output['edit']['proposal_id'].'"><i class="fa fa-book"></i> Upload LPJ</a>','success'); ?>
		</div>
		<?php 
	}
	?>
		...
		<div class="panel panel-warning">
			<div class="panel-heading">
				<h3 class="panel-title">
					...
					Document Detail Proposal <?php echo $output['detail']['name']; ?>
					<?php 
					if(@$output['edit']['file']) 
					{
						?>
	...
	<div class="col-xs-12 col-sm-4">
		<div class="panel panel-danger">
			<div class="panel-heading">
				...
				Document Timeline Proposal <?php echo $output['detail']['name']; ?>
			</div>
			<div class="panel-body">
				<div class="tree">
					<ul>
	...
	<div class="col-xs-12">
		<div class="panel panel-info">
			<div class="panel-heading">
				<h3 class="panel-title">Document Viewer Proposal <?php echo $output['detail']['name']; ?></h3>
			</div>
			<div class="panel-body">
				<?php 
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			<h3 class="panel-title">
				...
				<?php echo (@$output['edit']['id']) ? 'Edit' : 'Add'; ?> Document Proposal <?php echo $output['detail']['name']; ?>
			</h3>
		</div>
		<div class="panel-body">
			<?php 
			...
			<form action="" method="POST" role="form" enctype="multipart/form-data">
				...
				<input type="hidden" name="params[max_apbu]" value="<?php echo $output['detail']['max_apbu']; ?>">
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h3 class="panel-title">
				...
				History Document Proposal <?php echo $output['detail']['name']; ?>
			</h3>
		</div>
		<div class="panel-body">
			<div class="table-responsive">
